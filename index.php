...
<div class="row flex-lg-row-reverse align-items-center g-5 py-5">
    <div class="col-10 col-sm-8 col-lg-6">
        <img src="assets/images/logo-tech-trendz.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes"
             width="700" height="500" loading="lazy">
    </div>
    <div class="col-lg-6">
        <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">TechTrendz : L'actu tech !</h1>
        <p class="lead">
            Plongez dans l'univers passionnant de la technologie sur TechTrendz, votre portail d'information
            incontournable pour explorer les avancées les plus récentes, les tendances émergentes et les innovations qui
            façonneront notre avenir numérique.</p>
...
<div class="row text-center">
    ...
    <div class="col-md-4 my-2 d-flex">
        <div class="card">
            <img src="/uploads/articles/2-react-vs-react-native.jpg" class="card-img-top"
                 alt="React Natives : Quelles différences par rapport à React">
            <div class="card-body">
